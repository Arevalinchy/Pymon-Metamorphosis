    ...
    while True:
        ...
        if button_2.collidepoint((mx, my)):
            if click:
                ...
                character_select.characters(screen)
...
def opciones():
    ...
    while running:
        ...
        #SE DIBUJAN LOS BOTONES
        pygame.draw.rect(screen, (39, 57, 161), button_EXTRA)
        pygame.draw.rect(screen, (39, 57, 161), button_SONIDOS)
        
        #DETALLES BOTON
        detalles_buttonE = pygame.Rect(780, 820, 460, 90)
        detalles_buttonS = pygame.Rect(780, 620, 460, 90)
        
        pygame.draw.rect(screen, (0,0,0),  detalles_buttonE)
        pygame.draw.rect(screen, (0,0,0), detalles_buttonS)

        #TEXTO PARA IR A OPCIONES
        texto = letra_boton2.render("SONIDOS", True, (255, 255, 255))
        screen.blit(texto, (820,630))
        
        #TEXTO PARA IR EL JUEGO
        texto = letra_boton2.render("EXTRAS", True, (255, 255, 255))
        screen.blit(texto, (840,825))
        
        #MEGAFONO    
        screen.blit(megafono_scaled, (1250,560))
        
        screen.blit(megafonosc_scaled, (1250,560))
